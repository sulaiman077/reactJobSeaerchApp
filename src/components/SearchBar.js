...
const SearchBar = ({ fetchJobs }) => {  // Accept fetchJobs as a prop
  ...
  useEffect(() => {
    fetchJobs(search, selectedAgencies, selectedFields, selectedTypes, selectedExperiences, "EMPTY");
  ...
  const handleSearchInput = (e) => {
    ...
    if (e.key === 'Enter') {
      fetchJobs(search, selectedAgencies, selectedFields, selectedTypes, selectedExperiences, "NONEMPTY");
    }
    if(e._reactName === 'onClick'){
      fetchJobs('', selectedAgencies, selectedFields, selectedTypes, selectedExperiences, "EMPTY");
    }
  };
